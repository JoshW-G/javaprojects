...
public class Calculator
{
   ...
   public double calculate(double x)
   {
      ...
      else if (lastOperator.equals("%")) result = result%x;
      //else if (lastOperator.equals("+/-")) x= -x; //result = x;
      else if (lastOperator.equals("")) result = (result*10) + x;
      else if(lastOperator.equals(".")) result = ((result*10) +  x)/10;
